if Code.ensure_loaded?(GenAI.Provider.LocalLLama) do
  defmodule GenAI.LocalLLamaTest do
    ...
    test "inference" do
        thread = GenAI.chat()
                 |> GenAI.with_model(GenAI.Provider.LocalLLama.Models.priv("local_llama/tiny_llama/tinyllama-1.1b-chat-v1.0.Q4_K_M.gguf"))
        ...
        assert choice_one.message.content =~ "Dave, I'm afraid I can't do that."
