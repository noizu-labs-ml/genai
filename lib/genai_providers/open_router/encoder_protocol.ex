defprotocol GenAI.Provider.OpenRouter.EncoderProtocol do
  @moduledoc """
...
defimpl GenAI.Provider.OpenRouter.EncoderProtocol, for: GenAI.Tool do
...
defimpl GenAI.Provider.OpenRouter.EncoderProtocol, for: GenAI.Message do
  def content(content)
...
defimpl GenAI.Provider.OpenRouter.EncoderProtocol, for: GenAI.Message.ToolResponse do
  def encode(subject, _model, session, _context, _options) do
    encoded = %{
      role: :tool,
...
defimpl GenAI.Provider.OpenRouter.EncoderProtocol, for: GenAI.Message.ToolUsage do
