defprotocol GenAI.Provider.ZAI.EncoderProtocol do
  @moduledoc """
  ...
  again.
  """
  # ⟦𓁌𓇫𓆾𓅄⟧ encode :: auto-generated pointer for public function encode
...
# GenAI.Tool
# -----------------------------
defimpl GenAI.Provider.ZAI.EncoderProtocol, for: GenAI.Tool do
...
# GenAI.Message
# -----------------------------
defimpl GenAI.Provider.ZAI.EncoderProtocol, for: GenAI.Message do
  # ⟦𓃝𓍈𓐄𓉨⟧ content :: auto-generated pointer for public function content
  def content(content)
...
# -----------------------------
defimpl GenAI.Provider.ZAI.EncoderProtocol, for: GenAI.Message.ToolResponse do
  def encode(subject, _model, session, _context, _options) do
    encoded = %{
      role: :tool,
...
# -----------------------------
defimpl GenAI.Provider.ZAI.EncoderProtocol, for: GenAI.Message.ToolUsage do
  # ⟦𓂹𓎡𓌭𓇫⟧ encode_call :: auto-generated pointer for public function encode_call
