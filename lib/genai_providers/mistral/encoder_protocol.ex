defprotocol GenAI.Provider.Mistral.EncoderProtocol do
  @moduledoc """
...
# GenAI.Tool
#-----------------------------
defimpl GenAI.Provider.Mistral.EncoderProtocol, for: GenAI.Tool do
...
#-----------------------------
defimpl GenAI.Provider.Mistral.EncoderProtocol, for: GenAI.Message.ToolResponse do
  def encode(subject, model, session, context, options) do
    encoded = %{
      role: :tool,
...
#-----------------------------
defimpl GenAI.Provider.Mistral.EncoderProtocol, for: GenAI.Message.ToolCall do
  def encode(subject, model, session, context, options) do
